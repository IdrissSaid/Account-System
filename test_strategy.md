...
| ID | Description | Entrées | Sortie Attendue |
|----|-------------|---------|-----------------|
...
1. **Tests Unitaires Python**
   - unittest : Framework de test standard de Python
   - Fonctions mock intégrées pour simuler des comportements

2. **Tests E2E**
   - subprocess : Pour automatiser les interactions avec les programmes
   - Capture d'entrées/sorties standard
